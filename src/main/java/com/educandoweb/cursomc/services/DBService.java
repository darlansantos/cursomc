...
import com.educandoweb.cursomc.enums.EstadoPagamento;
import com.educandoweb.cursomc.enums.Perfil;
import com.educandoweb.cursomc.enums.TipoCliente;
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "darlanparreiras@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("12345"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "anacosta@gmail.com", "65643926059", TipoCliente.PESSOAFISICA, pe.encode("12345"));
		cli1.getTelefones().addAll(Arrays.asList("38457293", "238947573"));
		cli2.addPerfil(Perfil.ADMIN);

		Endereco e1 = new Endereco(null, "Rua Flores", "300", "Apto 303", "Jardim", "38220834", cli1, c1);
		Endereco e2 = new Endereco(null, "Avenida Matos", "105", "Sala 800", "Centro", "38777012", cli1, c2);
		Endereco e3 = new Endereco(null, "Avenida Floriano", "218", null, "Centro", "2945795", cli2, c2);
